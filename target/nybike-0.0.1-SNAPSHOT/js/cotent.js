function addBikeWindowInfoContent() {

    var bikeWindowInfoContent = "<div class='mapbox-content'>" +
        ...
        "<h1 class='mapbox-content-header-stationName'>info_stationName111</h1>" +
        "</div>" +
        ...
        "<span class='mapbox-content-footer-shortName'> Bike station:info_shortName </span>" +
        "</div>" +
        "</div>";
